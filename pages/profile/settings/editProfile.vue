    ...
    <div class="row justify-content-center">
        <div class="col-md-5">
            ...
            <form @submit.prevent="updateProfile">
                ...
                <inputs-form-control id="name" v-model="name"> الاسم </inputs-form-control>
                ...
                <div class="form-group">
                    <inputs-form-control textarea name="descripe" rows="5" v-model="description"> الوصف
                    </inputs-form-control>
                </div>
                <div class="flex-center">
...
export default {
    ...
    methods: {
        ...
        async updateProfile() {
            ...
            await this.axios.post('/update-profile', this.formData, {
                headers: {
