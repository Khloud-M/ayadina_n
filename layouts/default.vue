        ...
        <div class="container">
            <div class="flex-between py-3">
                ...
                <ul class="d-flex align-items-center gap-20 project-nav "  v-if="isAuth">
                    ...
                    <li>
                        <NuxtLink :to="localePath('/profile')" class="main_color">{{ $t('personalFile') }}</NuxtLink>
                    </li>
                    <li>
                ...
                ">
                    ...
                    <li>
                        <NuxtLink :to="localePath('/login')" class="main_color"> {{ $t('login') }}</NuxtLink>
                    </li>
                    <li>
                        <lang-switcher></lang-switcher>
                    </li>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-3">
                        ...
                        <ul>
                            <li class="mb-2">
                                <NuxtLink :to="localePath('/')" class="text-dark">{{ $t("home_title") }}</NuxtLink>
                            </li>
                            <li class="mb-2">
                                <NuxtLink :to="localePath('/commision')" class="text-dark"> {{ $t('commission') }}
                                </NuxtLink>
                            </li>
                            <li class="mb-2">
                                <NuxtLink :to="localePath('/contactUs')" class="text-dark"> {{ $t('contact_us') }}
                                </NuxtLink>
                            </li>
                        </ul>
                    </div>
                    <div class="col-md-3">
                        ...
                        <ul>
                            <li class="mb-2">
                                <NuxtLink :to="localePath('/aboutUs')" class="text-dark"> {{ $t('aboutWebsite') }}
                                </NuxtLink>
                            </li>
                            <li class="mb-2">
                                <NuxtLink :to="localePath('/fqs')" class="text-dark"> {{ $t('fqs') }}</NuxtLink>
                            </li>
                            <li class="mb-1">
